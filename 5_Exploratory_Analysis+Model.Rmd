...
### Различаются ли кластеры по плотности (density) графов и влияла ли плотность на темпы сжатия расселения?

Различия между районами есть, но параметр
...
##### Различаются ли кластеры по показателям централизации и влияла ли централизация на темпы сжатия расселения?
